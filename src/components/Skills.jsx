...
const skillCategories = [
  {
    ...
    subtitle: "Interfaces e aplicações web",
    icon: <FaCode />,
    skills: [
  ...
  },
  {
    id: "ui-ux",
    title: "UI / UX Design",
    subtitle: "Design e prototipação",
    icon: <FaPaintBrush />,
    skills: [
  ...
  {
    id: "tools",
    title: "Ferramentas & Build",
    subtitle: "Versionamento e build",
              ...
              >
                ...
                <div
                  className={`${styles.chevron} ${
                    activeCategory === category.id ? styles.rotated : ""
                  }`}
                >
                  <FaChevronDown />
                </div>
                        ...
                        {category.skills.map((skill, index) => (
                          ...
                          >
                            <div className={styles.skillHeader}>
                              {skill.icon}
                              <span
                                className={`notranslate ${styles.skillName}`}
                                translate="no"
                              >
                                {skill.name}
                              </span>
